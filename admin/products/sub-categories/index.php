                    ...
                    <div class="shadow-lg br10">
                      <div class="flex-s-b">
                        ...
                        <div class="item-details p-1">
                          ...
                          <a href="<?php echo DOMAIN; ?>/controller/productscontroller.php?delete_sub_categories=true&request=<?php echo SECURE($ProSubCategoriesId, "e"); ?>&data=<?php echo SECURE("pro_sub_categories", "e"); ?>&validation=<?php echo SECURE(IP_ADDRESS, "e"); ?>&access_url=<?php echo SECURE(RUNNING_URL, "e"); ?>" class="btn-sm text-danger"><i class="fa fa-trash"></i> Delete</a>
                        </div>
                      </div>
                    </div>
                  </div>
