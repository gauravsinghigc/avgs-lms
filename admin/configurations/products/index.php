                    ...
                    <div class="shadow-lg br10">
                      <div class="flex-s-b">
                        ...
                        <div class="item-details p-1">
                          ...
                          <a href="<?php echo DOMAIN; ?>/controller/productscontroller.php?delete_categories=true&request=<?php echo SECURE($ProCategoriesId, "e"); ?>&data=<?php echo SECURE("pro_categories", "e"); ?>&validation=<?php echo SECURE(IP_ADDRESS, "e"); ?>&access_url=<?php echo SECURE(RUNNING_URL, "e"); ?>" class="btn-sm text-danger"><i class="fa fa-trash"></i> Delete</a>
                        </div>
                      </div>
                    </div>
                  </div>
