...
//page variables
$PageName = "Update Customer Details";
$Requested_CustomerId = Req_Data("customerid", "GET", true, "dec");
$PageSqls = "SELECT * FROM customers where CustomerId='$Requested_CustomerId'";
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="col-md-12">
                  <div class="flex-s-b">
                    <div class="btn-group btn-group-sm">
                      <a href="<?php echo DOMAIN; ?>/admin/customers/index.php" class="btn btn-sm btn-primary square"><i class="fa fa-angle-left"></i> Back to All</a>
                    </div>
                  </div>
                </div>
                      ...
                      <div class="input-block">
                        ...
                        <div class="form-group form-group-2 flex-s-b">
                          ...
                          <div class="raw-inputs" onclick="tax()">
                            <?php if (GET_DATA("CustomerType") == "Company") { ?>
                              <span>
