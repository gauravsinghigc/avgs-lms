                        ...
                        <div class="main mb-1-pr pb-2">
                            ...
                            <form role="form" action="../../../controller/authcontroller.php" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="UserEmailId" value="" placeholder="* * * * * *" required="" class="form-control text-center otp-input" id="inputUsernameEmail">
                                </div>
                                <button type="submit" name="ResetPassword" class="btn btn btn-secondary btn-block p-2 fs-18">
